...
-- COP <-> PLAYER is toggled by qbx_disableservices (npcPoliceActive) instead of hardcoded here -
-- it needs to flip to Hate for native police to actually engage a wanted player.
