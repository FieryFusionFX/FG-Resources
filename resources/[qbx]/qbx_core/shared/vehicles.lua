...
return {
    ...
    -- BigCarPack import (github.com/Zerofour04/Fivem-BigCarPack) - 174 real-brand vehicles under a new imports category
    ['124spider'] = {
        name = '124',
        brand = 'Abarth',
        model = '124spider',
    ...
    srt8b = {
        name = 'Grand Cherokee Srt8 (srt8b)',
        brand = 'Jeep',
        model = 'srt8b',
        price = 68000,
        category = 'imports',
    ...
    lp570 = {
        name = 'Gallardo Supperlegera 2013',
        brand = 'Lamborghini',
        model = 'lp570',
        price = 351000,
        category = 'imports',
