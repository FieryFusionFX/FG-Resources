...
return {
    ...
    garages = {
        -- Public Garages
        -- skipGarageCheck = true on every public garage below: a vehicle stored at any one of them
        -- (or at a player's apartment, see qbx_properties) can be pulled out from any other one.
        motelgarage = {
            label = 'Motel Parking',
