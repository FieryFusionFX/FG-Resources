...
local function tryToggleSeatbelt()
...
lib.addKeybind({
    ...
    onPressed = tryToggleSeatbelt
})

-- Chat command fallback in case the B keybind is unbound or conflicting in a player's FiveM settings
RegisterCommand('seatbelt', tryToggleSeatbelt, false)
