...
-- Only drug contraband is lost on death/respawn - cash, phone, weapons, and everything else stay
-- with the player. Keep this list in sync with the equivalent one in xt-prison/server/sv_main.lua.
local drugItems = {
