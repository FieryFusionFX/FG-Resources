...
CreateThread(function() -- all these should only need to be called once
    ...
    -- Whether random cops get created is toggled by qbx_disableservices (npcPoliceActive),
    -- not hardcoded here, so native police can actually spawn when there's no on-duty player LEO.
